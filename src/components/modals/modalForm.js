document.addEventListener("DOMContentLoaded", function () {
    ...
    modalOverlay.className =
        "modal-overlay hidden w-full h-full bg-black/50 fixed z-[10] inset-0 flex items-center justify-center";
    ...
    function handleFormSubmit(e) {
        ...
        const fullName = modalOverlay
            .querySelector('input[placeholder="ФИО"]')
            ?.value.trim();
        const phone = modalOverlay
            .querySelector('input[placeholder="Ваш телефон"]')
            ?.value.trim();
        ...
        ym(103763307, 'reachGoal', 'Vse_celi');
