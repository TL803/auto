document.addEventListener("DOMContentLoaded", function () {
    ...
    function createExitModal() {
      ...
      modal.className =
        "bg-[#4886FF] text-white rounded-[14px] shadow-xl max-w-lg w-full relative overflow-hidden";
      modal.innerHTML = `
      ...
      document
        .getElementById("exit-modal-close")
      ...
      document
        .getElementById("exit-modal-form")
        .addEventListener("submit", (e) => {
          ...
          document
            .getElementById("exit-modal-close-thanks")
            .addEventListener("click", () => {
              overlay.remove();
            });
        });
